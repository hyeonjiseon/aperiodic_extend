function [BRid,P_MHz,lambda,Nreassign] = BRreassignmentControlledPC(IDvehicle,BRid,P_MHz,CHgain,awarenessID,Nbeacons,lambda,gammaMin,Pnoise_MHz,blockTarget,maxERP_MHz)
...
for i = 1:Nbeacons
    ...
    p(index) = (p(index)/max(p(index)))*maxERP_MHz;
end
