...
%             for j = 1:appParams.Nbeacons
%                 for k=1:9
%                     stationManagement.updateReserveMatrix(j,k,i) = stationManagement.updateReserveMatrix(j,k+1,i);
%                     if k== 9
%                         stationManagement.updateReserveMatrix(j,10,i)=0;
%                     end
%                 end
%             end
%         end                 
...
%YJ
averageCBR = sinrManagement.sumCBR/sinrManagement.countCBR;
averageAvailableResourceRatio = stationManagement.availableResourceRatio/stationMAnagement.reselectionNum;
